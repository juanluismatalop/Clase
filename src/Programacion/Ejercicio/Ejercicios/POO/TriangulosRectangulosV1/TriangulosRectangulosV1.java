package Programacion.Ejercicio.Ejercicios.POO.TriangulosRectangulosV1;public class TriangulosRectangulosV1 {
    private int cateto1;
    private int cateto2;

    public TriangulosRectangulosV1(int cateto1, int cateto2) {
