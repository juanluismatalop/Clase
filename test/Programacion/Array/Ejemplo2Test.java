...
import Programacion.Ejercicio.Array.Ejemplo2;
...
class Ejemplo2Test {
    ...
    assertArrayEquals(new char[]{'c', 'b', 'a'}, Ejemplo2.invertirArrayChar(new char[]{'a', 'b', 'c'}));
    assertArrayEquals(new char[]{'d', 'c', 'b', 'a'}, Ejemplo2.invertirArrayChar(new char[]{'a', 'b', 'c', 'd'}));
